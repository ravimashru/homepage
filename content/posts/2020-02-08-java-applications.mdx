...
import javaAppsUrl from '../images/java_applications.png';
...
Very recently, when I decided to learn a bit more about Java from Sander Mak’s course on Pluralsight - [Modern Java: The Big Picture](https://www.pluralsight.com/courses/modern-java-big-picture), I finally got a big picture view of the different things Java was capable of (apart from, of course, counting the number of vowels in a sentence).

<br />

<img src={javaAppsUrl} alt="java applications" width="100%" />