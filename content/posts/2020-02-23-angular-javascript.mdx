...
import angularJsUrl from '../images/angular_js.png';
...
<img src={angularJsUrl} alt="angular and javascript" width="100%" />
...
**Create a namespace for the functions we will create**
...
**Use a function in the created namespace as a click handler**
...
**Define the function used as a click handler**
